...
public class IMGTranscoder {
    ...
    public static Image toFXImage(InputStream is) {
        try {
            return SwingFXUtils.toFXImage(rasterize(is), null);
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static BufferedImage rasterize(InputStream is) throws IOException {
